...
<div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0"><a href="index.html">Ana Sayfa</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Ürünler</strong></div>
      </div>
    </div>
  </div>
              ...
              <div class="d-flex">
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                    <a class="dropdown-item" href="#" data-sira="a_z_order">A -> Z</a>
                    <a class="dropdown-item" href="#" data-sira="z_a_order">Z -> A</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#" data-sira="price_min_order">Fiyat, Düşük -> Yüksek</a>
                    <a class="dropdown-item" href="#" data-sira="price_max_order">Fiyat, Yüksek -> Düşük</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                @foreach ($products as $product)
                    <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                        ...
                        <figure class="block-4-image">
                            <a href="{{route("urundetay", $product->slug)}}"><img src="{{asset($product->image ?? "images/cloth_1.jpg")}}" alt="Image placeholder" class="img-fluid"></a>
                        </figure>
